...
uint8_t binary_Values[6] = {0b10101010, 0b01010101, 0b11001100, 0b00110011, 0b11110000, 0b00001111};
...
void TIM16_IRQHandler(void)
{
   ...
   value = read_from_address(position);    
      
   if(value == binary_Values[position]){
     GPIOB -> ODR = value;               //
     position++;
   }
